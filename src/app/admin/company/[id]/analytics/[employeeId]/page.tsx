        ...
        <div className="min-h-screen bg-gray-50 dark:bg-black p-4 sm:p-8">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {/* Channel Breakdown */}
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-gray-200 dark:border-zinc-800 shadow-sm h-fit">
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-gray-200 dark:border-zinc-800 shadow-sm">
                        ...
                        <div className="space-y-0 divide-y dark:divide-zinc-800">
