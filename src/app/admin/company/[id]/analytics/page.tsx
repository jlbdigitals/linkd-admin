                            ...
                            {[...company.employees]
                                ...
                                .map((emp) => (
                                    <Link
                                        ...
                                        key={emp.id}
                                        className="flex items-center justify-between group hover:bg-gray-50 dark:hover:bg-zinc-800 p-2 rounded-lg transition-colors cursor-pointer"
                                    >
                                ...
                                .map((item) => (
                                    <div key={item.buttonType} className="space-y-2">
                                        <div className="flex justify-between text-sm">
                                            <span className="capitalize font-medium text-gray-700 dark:text-gray-300">{item.buttonType || "Otro"}</span>
