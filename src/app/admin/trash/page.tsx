    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <header className="flex flex-col gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground">Papelera de Reciclaje</h1>
            ...
            <section className="space-y-4">
                {deletedCompanies.length === 0 ? (
                    <div className="text-center py-12 bg-muted/20 rounded-xl border border-dashed border-border">
                        <p className="text-muted-foreground italic">No hay empresas en la papelera.</p>
                    </div>
                ) : (
                    <div className="grid gap-4">
                        {deletedCompanies.map((company) => {
                            ...
                            return (
                                <div
                                    key={company.id}
                                    className="bg-card border border-border p-6 rounded-xl flex justify-between items-center group"
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                        <form action={restoreCompany}>
                                            ...
                                            <Button
                                                variant="outline"
                                                size="sm"
                                                className="gap-2 border-green-500/20 text-green-600 hover:bg-green-500/10 hover:text-green-500"
                                            >
                                                <RotateCcw size={16} />
                                                Restaurar
                                            </Button>
